...
namespace AuctionsMain.Controllers
{
    public class ListingsController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? pageNumber, string searchString)
        {
            ...
            if (!string.IsNullOrEmpty(searchString))
            {
                ...
                return View(await PaginatedList<Listing>.CreateAsync(applicationDbContext.Where(l => l.IsSold == false).AsNoTracking(), pageNumber ?? 1,
                    pageSize));
            }
        ...
        //        return NotFound();
        //    }
        //    ViewData["IdentityUserId"] = new SelectList(_context.Users, "Id", /"Id",/ ////i/in/g.I/ityUserId);
        //    return View(listing);
        //}
        //
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, ///[////"Id,Title,Description,Price,ImagePath,IsSold,IdentityUserId")] Listing listing)
        //{
        //    if (id != listing.Id)
        //    {
        //        return NotFound();
